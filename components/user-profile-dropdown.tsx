        ...
        <DropdownMenuContent className="w-64" align="end" sideOffset={5}>
          <div className="flex items-center gap-3 p-3">
            ...
            <div className="flex flex-1 flex-col">
              ...
              <span className="text-xs text-muted-foreground">arjun01@gmail.com</span>
            </div>
          </div>
          <DropdownMenuSeparator />
          <div className="p-2">
          ...
          <div className="p-2">
            <div className="rounded-md bg-orange-100 px-3 py-2">
              <span className="text-sm font-medium text-orange-800">Credits: 0</span>
            </div>
          </div>
          <DropdownMenuSeparator />
          <DropdownMenuItem asChild>
            <Link href="/bookmarks" className="flex cursor-pointer items-center gap-2">
          ...
          <DropdownMenuItem asChild>
            <Link href="/sign-out" className="flex cursor-pointer items-center gap-2">
